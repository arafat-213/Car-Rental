			...
			<form class="form-horizontal" action='' method="POST">
			  <fieldset>
			    ...
			    <div class="control-group">
			      ...
			      <div class="control-group">
			      <!-- address -->
			      <label class="control-label"  for="phone-no">Contact Number</label>
			      <div class="controls">
			  	  <input type="text" id="phone-no" name="tph" placeholder="" class="input-xlarge">
			      </div>
			    </div>
			      <!-- <div class="control-group"> 
...
<?php
	...
	if($sub == "sign up"){
		...
		$link -> query("insert into login values ('$us', '$pa', '$phone')");
		$link -> close();
