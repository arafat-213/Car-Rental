...
<body style="background-color: rgba(248,248,248,0.5);">
    ...
    <?php
		...
		{
		echo "<tbody> <tr>";
		echo "<td class='text-uppercase' class='bg-light text-dark'>" . $row['car_selected'] . "</td>";
